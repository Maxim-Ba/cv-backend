...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.AboutMeDTO"
                        }
                    },
                    "404": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.EducationListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/edu/{eduID}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID записи образования",
                        "name": "eduID",
                        "in": "path",
                        "required": true
                    }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.TechListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.TechnologyWithTagsDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.WorkHistoryListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.WorkHistoryDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.WorkHistoryWithTechnologiesDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "dto.WorkHistoryWithTechnologiesDTO": {
            "type": "object",
            "properties": {
                "about": {
                    "type": "string"
